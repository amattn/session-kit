...
### DEC_6: API endpoint prefix — API (2026-03-14)
Added `API` as a stable label prefix for tracking API endpoints. Enables greppable cross-referencing of endpoints across docs, code, and tests.
