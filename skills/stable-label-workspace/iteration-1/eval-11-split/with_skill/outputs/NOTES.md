...
### REQ_5: No database mocking in unit tests (split from REQ_3)
Unit tests must hit a real database. Same rationale as REQ_3 — mock/prod divergence burned the team.
