...
### REQ_6: 200ms response time SLA (2026-03-14)
All API endpoints must respond within 200ms under normal load. This is a hard requirement — any endpoint exceeding this threshold is a bug to be investigated and fixed.
