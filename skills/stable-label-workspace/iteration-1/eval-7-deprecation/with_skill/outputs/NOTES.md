...
### DEC_6: Drop mobile app (2026-03-14)
Mobile app is no longer being built. REQ_5 (mobile app support / offline sync) deprecated as a result.
...
### REQ_5: ~~Mobile app support~~ — DEPRECATED (see DEC_6)
API must support the companion mobile app with offline sync capabilities.
**Deprecated:** Mobile app was dropped; this requirement is no longer relevant.
