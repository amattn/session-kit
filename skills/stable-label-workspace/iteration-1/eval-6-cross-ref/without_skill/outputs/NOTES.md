...
Redis rejected as overkill for now. Also aligns with REQ_3 (no database mocking in tests) — in-memory caching is simpler to test against real infrastructure without needing a separate Redis instance.
