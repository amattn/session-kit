...
`[resolved]` — Added "Rename Discipline" section to CLAUDE.md with enforced three-step checklist: consistency pass, NOTES.md update, stale-reference verification.
