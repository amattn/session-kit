...
`[resolved]` → Promoted to CLAUDE.md as "Consistency Pass After Renames" directive.
Four-step checklist: search for old name, update all references, verify none remain,
then proceed.
