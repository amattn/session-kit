...
When presenting options or asking for feedback, use structured numbered options instead of open-ended "anything else?" prompts. Aim to resolve review cycles in a single round where possible.
