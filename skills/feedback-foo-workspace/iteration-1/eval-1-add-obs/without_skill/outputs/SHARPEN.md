...
### SPI_4: Agent forgets to run tests after making changes [friction]

User-reported pattern. After modifying code, the agent moves on without running
the test suite. This risks shipping broken changes and forces the human to
manually catch regressions.
